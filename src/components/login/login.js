 ...
 const fetchAccount=()=>{
    ...
    return (
        <div className="login-container">
            ...
            <Link to='/'><img className="lo-logo" src="https://dog55574plkkx.cloudfront.net/storelogo/web/gaana.png" alt="log-logo"/></Link>
               
            </div>
            <div className="right-container">
                <div className="account">
                   <p className="account-toggle-text">Don't have a Gaana account yet?</p><Link to='/signup'><button className="sign-btn">Sign Up</button></Link>
                </div>
                <div className="login-form">
                    <h1>Welcome to Gaana.</h1>
                    <p className="loginpara">Log in or sign up with your mobile number.</p>
                    <div className={error?"errorBox":"hiddenBox"}>{message}
